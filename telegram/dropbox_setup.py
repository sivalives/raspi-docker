#!/bin/env python3
####
##Setup app here : https://www.dropbox.com/developers/apps/create
##get the app key and app secret and setup in an .env file within docker container and start this script
####
import os
import sys
import logging
